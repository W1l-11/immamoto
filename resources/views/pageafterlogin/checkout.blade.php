...
<div class="deskripsi">
  <div class="flex flex-col gap-2">
        ...
        <p class="font-bold text-lg">Lama Penggunaan :       </p>
        <p class="font-bold text-lg">Deskripsi</p>
        <p class="font-medium text-stone-400 text-base">psadagsgdjhagdhsa</p>
        <br>
        <p class="font-bold text-2xl">Jumlah :</p>
...
<div class="deskripsi_bawah">
  <div class="flex flex-col gap-2">
        <p class="font-bold text-lg">Nama Penerima :      </p>
        <p class="font-bold text-lg">Alamat Pengiriman :        </p>
        <p class="font-bold text-lg">Opsi Pengiriman :       </p>
...
<div class="deskripsi_bawah_lanjutan">
  <div class="flex flex-col gap-2">
        ...
        <p class="font-bold text-lg">Biaya Pengiriman :        </p>
        <p class="font-bold text-lg">Potongan Harga :       </p>
...
<div class="riwayat flex flex-row">
    <div class="pembungkus px-12">
        <div class="relative flex flex-col text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-[88rem] px-4 py-2">
            <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-clip-border rounded-xl h-96">
                ...
                <div class="isi_card flex flex-row justify-between">
                    <div class="payment_option py-8 px-4 gap-2">
                        <div class="bca flex flex-row items-center gap-2">
                            <input type="radio" name="payment_method">
                            <img src="../images/bca.png" alt="" class="w-20 px-4">
                            <p class="font-bold text-base px-4">Bank BCA</p>
                        </div>
                        <div class="mandiri flex flex-row items-center gap-2">
                            <input type="radio" name="payment_method">
                            <img src="../images/mandiri.png" alt="" class="w-24 px-4">
                            <p class="font-bold text-base">Bank Mandiri</p>
                        </div>
                        <div class="bni flex flex-row items-center gap-2">
                            <input type="radio" name="payment_method">
                            <img src="../images/bni.png" alt="" class="w-24">
                            <p class="font-bold text-base">Bank BNI</p>
                        </div>
                        <div class="bri flex flex-row items-center gap-2">
                            <input type="radio" name="payment_method">
                            <img src="../images/bri.png" alt="" class="w-24 px-4">
  ...
  <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
    ...
    <div class="modal-content py-4 text-left px-6">
      ...
      <div class="flex justify-between items-center pb-3">
        ...
        <button id="close-modal" class="modal-close px-4 py-2 bg-gray-800 text-white text-xl rounded-full focus:outline-none">&times;</button>
      </div>
