...
<div class="deskripsi_bawah">
  <div class="flex flex-col gap-2">
        ...
        <p class="font-bold text-lg">Nomor Resi Pengiriman :       </p>
...
<div class="bungkus flex justify-center">
<div class="total_border border-2 rounded-full w-[88rem]">
  <div class="text_tengah flex flex-col items-center">
    <p class="font-bold text-lg">Total: Rp</p>
    <p class="font-bold text-lg">Hemat: Rp</p>
  </div>
</div>
</div>
